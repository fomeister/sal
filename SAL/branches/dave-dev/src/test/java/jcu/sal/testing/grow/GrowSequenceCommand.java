...
public class GrowSequenceCommand extends Message {
	...
	public GrowSequenceCommand(Message message) throws InvalidMessageException {
		super(message);

		if (message != null && !message.getName().equals(GrowMessageFactory.GROW_SEQUENCE_COMMAND_NAME)) {
			String em = "Incompatible message name -";
			em += " Expected: " + GrowMessageFactory.GROW_SEQUENCE_COMMAND_NAME;
