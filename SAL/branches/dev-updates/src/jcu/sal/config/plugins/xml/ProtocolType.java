 ...
 *         &lt;element name="ConfigPlugin" type="{http://sal.jcu.edu.au/schemas/pluginsConfig}NameClassType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ProtocolType {
    ...
    protected List<NameClassType> configPlugin;
     ...
     * 
     */
    public List<NameClassType> getConfigPlugin() {
        if (configPlugin == null) {
            configPlugin = new ArrayList<NameClassType>();
        }
