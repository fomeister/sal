...
public class SALClient implements EventHandler, StreamCallback{
	...
	public void run(){
		...
		try {
			agent.registerEventHandler(this, SensorManager.PRODUCER_ID);
			agent.registerEventHandler(this, ProtocolManager.PRODUCER_ID);
			agent.registerEventHandler(this, SensorState.PRODUCER_ID);
		...
		while(sid!=-1) {
			...
			try {
				...
				if(sid>=0) {
					...
					System.out.println(agent.getCML(String.valueOf(sid)));
		...
		try {
			agent.unregisterEventHandler(this, SensorManager.PRODUCER_ID);
			agent.unregisterEventHandler(this, ProtocolManager.PRODUCER_ID);
			agent.unregisterEventHandler(this, SensorState.PRODUCER_ID);
